...
class SubTaskType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add(
                ...
                [
                    ...
                    'property' => 'fullname',
                    'data'     => (null === $builder->getData()->getReporter())
                        ? $user
                        : $builder->getData()->getReporter()
                ]
            )
            ->add(
                'assignee',
                ...
                [
                    'class'    => 'SbtsUserBundle:User',
                    'property' => 'fullname',
                    'data'     => (null === $builder->getData()->getAssignee())
                        ? $user
                        : $builder->getData()->getAssignee()
                ]
            )
            ->add(
                'priority',
        ...
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) {
            ...
            if (!$issue || null === $issue->getId()) {
                $builder->add('save', 'submit', ['label' => 'issue.form.create']);
            } else {
                $builder->add('save', 'submit', ['label' => 'issue.form.update']);
            }
        });
    }
    ...
    {
        return 'sbts_issue_subtask_form';
    }
}
